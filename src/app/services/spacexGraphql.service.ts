...
export type CompanyDetailQueryVariables = Exact<{ [key: string]: never; }>;
...
export type PastLaunchesListQuery = (
  ...
  & { launchesPast?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'mission_name' | 'launch_date_utc'>
    & { links?: Maybe<(
      { __typename?: 'LaunchLinks' }
...
export const CompanyDetailDocument = gql`
  ...
  export class CompanyDetailGQL extends Apollo.Query<CompanyDetailQuery, CompanyDetailQueryVariables> {
    document = CompanyDetailDocument;
    
  }
export const PastLaunchesListDocument = gql`
    query pastLaunchesList($offset: Int, $limit: Int) {
